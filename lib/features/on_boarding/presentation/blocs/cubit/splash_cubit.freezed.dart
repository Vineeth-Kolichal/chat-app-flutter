...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({required this.nextRoute});
  ...
  @override
  String toString() {
    return 'SplashState(nextRoute: $nextRoute)';
  }
...
abstract class _Initial implements SplashState {
  const factory _Initial({required final String? nextRoute}) = _$InitialImpl;
